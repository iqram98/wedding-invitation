    ...
    >
        ...
        <div class="p-6 rounded-xl text-center z-10 text-white">
            ...
            <button
                ...
                class="mt-10 tracking-wide bg-[#415e29] text-white px-6 py-2 rounded-full hover:bg-[#517a34] transition transform hover:scale-110 animate-pulse"
            >
                Open Invitation
            </button>
        </div>
